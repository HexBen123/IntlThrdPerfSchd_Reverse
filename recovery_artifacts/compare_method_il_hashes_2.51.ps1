param(
    ...
    [string]$RecoveredExe = "$PSScriptRoot\..\..\recovered_src_2.51\IntlThrdPerfSchd\bin\Release\net48\IntlThrdSchd.exe",
    [int]$MaxDiffLines = 200,
    [string]$OutPath = "$PSScriptRoot\method_il_hash_diff_2.51.txt"
)

$ErrorActionPreference = "Stop"

$dnlib = Resolve-Path "$PSScriptRoot\..\..\工具\nuget\dnlib\4.5.0\_extracted\lib\net6.0\dnlib.dll"
...
$origMap = Get-StableMethodMap -AssemblyPath $OriginalExe
$recMap = Get-StableMethodMap -AssemblyPath $RecoveredExe
