...
namespace IntlThrdPerfSchd
{
	public class ThreadFFNBlock
	{
		...
		public void Backward(ReadOnlySpan<float> gradOutput, float learningRate = 0.001f)
		{
			...
			_norm2.Backward(gradOutput, learningRate, accumulateGrad: false);
			...
			_norm1.Backward(inputGradients, learningRate, accumulateGrad: false);
		...
		public void ApplyGradients(float learningRate = 0.001f)
		{
			...
			_feedForward.FC1.ApplyGradientsSGD(learningRate, 1f);
			_feedForward.FC2.ApplyGradientsSGD(learningRate, 1f);
		}
