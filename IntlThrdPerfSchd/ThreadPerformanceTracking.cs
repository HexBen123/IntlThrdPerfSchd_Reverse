...
public class Tracker4lat
{
	...
	public int GetOptimalThreadId(bool maximizeValue1, bool maximizeValue2)
	{
		lock (_lockObject)
		{
			...
			IOrderedEnumerable<ThreadData> orderedData = ((!maximizeValue1) ? dataList.OrderBy((ThreadData d) => d.Value1) : dataList.OrderByDescending((ThreadData d) => d.Value1));
			orderedData = ((!maximizeValue2) ? orderedData.ThenBy((ThreadData d) => d.Value2) : orderedData.ThenByDescending((ThreadData d) => d.Value2));
