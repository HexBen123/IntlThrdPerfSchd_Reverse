...
public class Tracker4lat
{
	...
	public int GetOptimalThreadId(bool maximizeValue1, bool maximizeValue2)
	{
		lock (_lockObject)
		{
			...
			IOrderedEnumerable<ThreadData> source2 = ((!maximizeValue1) ? source.OrderBy((ThreadData d) => d.Value1) : source.OrderByDescending((ThreadData d) => d.Value1));
			source2 = ((!maximizeValue2) ? source2.ThenBy((ThreadData d) => d.Value2) : source2.ThenByDescending((ThreadData d) => d.Value2));
